...
class AWalkingRunningDistance:
    def __init__(self, googleFit_df, *args):
        ...
        self.records_df = googleFit_df[googleFit_df["dataSource"] == 'derived:com.google.distance.delta:com.google.android.gms:merge_distance_delta'].copy()
        ...
        if not self.filtered_records_df.empty:
            self.filtered_records_df['value'] = self.filtered_records_df['value'] / 1000
        else:
